...
?>
<!-- Check array -->
<?php /* print_r($node->field_sub_category_connected); */ ?>
	...
	<?php if(!empty($node->field_category_tab)) : ?>
		<div class="border-bottom-grey">
			<ul class="bg-white uppercase custom-nav-bars nav nav-tabs align-center font-size-12 no-padding" role="tablist">
				...
				?>
					<?php if ($item['value'] == "2"): ?>
						<li class="active"><a href="<?php print  $base_url . '/' . $path . '/media' ;?>">Magazine</a></li>
					<?php endif;?>
					<?php if ($item['value'] == "3"): ?>
	...
	<div class="container">
		...
		<div class="row clearfix row-eq-height">
			...
			<div class="col-12 col-sm-12 col-xs-12 col-md-9 col-lg-9 col-xl-9">
				<?php if((!empty($node->field_media_title)) || (!empty($node->field_media_description)) || (!empty($block))) : ?>
					<div class="bg-white border-radius-3 box-shadow">
				...
				<?php endif; ?>
				<?php
					$block = module_invoke('views', 'block_view', 'article_unique_content-category_magazine');
					if ($block):
				?>
					<?php print render($block['content']); ?>
					<br>
...
<?php if($node->type =='models_projects'): ?>
	...
	<div class="border-bottom-grey">
		<ul class="bg-white uppercase custom-nav-bars nav nav-tabs align-center font-size-12 no-padding" role="tablist">
			<li><a href="<?php print  $base_url . '/' . $path;?>">Home</a></li>
			<li class="active"><a href="<?php print  $base_url . '/' . $path . '/media'; ?>">News</a></li>
	...
	<div class="container">
		...
		<br>
		<?php 
			$article = module_invoke('views', 'block_view', 'models_projects-all_news'); 
		?>
        <?php if($article): ?>
			<div class="no-margin font-alt font-size-24 fw-600"><?php print($node->title); ?> News</div>
			<br>
			<div><?php print render($article['content']); ?></div>
			<br>
		<?php endif; ?>
		<!-- Contact Us Entity Form -->
		<div class="bg-white padding-15 border-radius-3 box-shadow">
